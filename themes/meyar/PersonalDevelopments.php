                    ...
                    <div class="row personalServices-items basePosition">
                        <div class="col-md-9 personalServices-contentItem">
                            <div class="personalServices-contentCard">
                                ...
                                <div class="row">
                                    <div class="col-md-8 personalservices-contentCard-text">
                                        <p class="m-0 Dana-Regular">ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود. ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود. ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود.</p>
                                    </div>
                                    <div class="col-md-4 personalServices-contentCard-title">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/services-checkbox.png" alt="Meyar">
                                        <h1 class="Bana-ExtraBold">رفاهیات و انگیزش کارکنان</h1>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 personalServices-tagItem">
                            <div class="personalServices-tagCard">
                                <div class="personalServices-tagCard-body" style="background-color: 
                                                                                <?php if ($i % 2 != 0) { ?>
                                                                                    #FDB913
                                                                                <?php } else { ?>
                                                                                    #75EABA 
                                                                                <?php } ?>
                                                                              ">
                                    <h1 class="Dana-Medium">0<?php echo $i+1 ?></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9 personalServices-contentItem">
                            <div class="personalServices-contentCard">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 personalservices-contentCard-text">
                                        <p class="Dana-Regular">ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود. ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود. ارزیابی و گزینش کارکنان فرآیندی نظام‌مند برای انتخاب بهترین فرد متناسب با شغل است که با تحلیل شغل (تعیین وظایف و شایستگی‌های مورد نیاز) آغاز می‌شود.</p>
                                    </div>
                                </div>
                                <div class="personalServices-contentCard-iconbox">  
                                    <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
